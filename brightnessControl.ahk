...
http://dl.dropbox.com/u/6428211/AutoHotkey/TNA-BADJ/nipb.bmp
...
Br := 96 ; Brightness Range: 10 - 128 where 0=darkest, 255=Brightest and 128 is Normal
IfNotExist, nipb.bmp
UrlDownloadToFile, http://dl.dropbox.com/u/6428211/AutoHotkey/TNA-BADJ/nipb.bmp, nipb.bmp
...
^LEFT::AdjustBrightness( +5 ) ;Ctrl + Left = Brightness Up
^RIGHT::AdjustBrightness( -5 ) ;Ctrl + Right = Brightness Down
#IfWinExist TNA Brightness Adjuster ahk_class AutoHotkeyGUI
WheelUp:: AdjustBrightness( +5 ) ;MouseWheelUp over Tray Icon = Brightness Up
;^WheelUp:: AdjustBrightness( +5 )
WheelDown::AdjustBrightness( -5 ) ;MouseWheelDown over Tray Icon = Brightness Down
...
NumPut( 0x2[color=red]|0x4[/color], NumPut( 1028, NumPut( DllCall( "FindWindow", Str,"AutoHotkey"
